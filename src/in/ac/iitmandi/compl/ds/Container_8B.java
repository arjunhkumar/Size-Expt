 ...
 *
 */
public class Container_8B {

	/** Estimated size of the container: 4 * 2 = 8B*/
	private InlineField_2B fieldX1;
	private InlineField_2B fieldY1;
	private InlineField_2B fieldX2;
	private InlineField_2B fieldY2;
	...
	public Container_8B() {
		...
		this.fieldX2 = new InlineField_2B();
		this.fieldY2 = new InlineField_2B();
	}
	 ...
	 * @return the fieldX2
	 */
	public InlineField_2B getFieldX2() {
		return fieldX2;
	}
	 ...
	 */
	public void setFieldX2(InlineField_2B fieldX2) {
	 ...
	 * @return the fieldY2
	 */
	public InlineField_2B getFieldY2() {
		return fieldY2;
	}
	 ...
	 */
	public void setFieldY2(InlineField_2B fieldY2) {
