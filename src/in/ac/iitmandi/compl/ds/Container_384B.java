 ...
 *
 */
public class Container_384B {

	/** Estimated size of the container: 32 * 8 = 256B*/
	private InlineField_32B fieldU1;
	private InlineField_32B fieldV1;
	...
	private InlineField_32B fieldU2;
	private InlineField_32B fieldV2;
	 ...
	 * @param fieldY
	 */
	public Container_384B() {
		this.fieldU1 = new InlineField_32B();
		this.fieldV1 = new InlineField_32B();
		...
		this.fieldU2 = new InlineField_32B();
		this.fieldV2 = new InlineField_32B();
	 ...
	 * @return the fieldU1
	 */
	public InlineField_32B getFieldU1() {
		return fieldU1;
	}

	/**
	 * @param fieldU1 the fieldU1 to set
	 */
	public void setFieldU1(InlineField_32B fieldU1) {
		this.fieldU1 = fieldU1;
	}

	/**
	 * @return the fieldU2
	 */
	public InlineField_32B getFieldU2() {
		return fieldU2;
	}

	/**
	 * @param fieldU2 the fieldU2 to set
	 */
	public void setFieldU2(InlineField_32B fieldU2) {
		this.fieldU2 = fieldU2;
	}

	/**
	 * @return the fieldV1
	 */
	public InlineField_32B getFieldV1() {
		return fieldV1;
	}

	/**
	 * @param fieldV1 the fieldV1 to set
	 */
	public void setFieldV1(InlineField_32B fieldV1) {
	 ...
	 * @return the fieldV2
	 */
	public InlineField_32B getFieldV2() {
		return fieldV2;
	}

	/**
	 * @param fieldV2 the fieldV2 to set
	 */
	public void setFieldV2(InlineField_32B fieldV2) {
